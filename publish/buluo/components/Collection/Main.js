...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Com = (function (_Component) {
	  ...
	  function Com() {
	    ...
	    _get(Object.getPrototypeOf(_Com.prototype), 'constructor', this).apply(this, arguments);

	    this.goToBarindex = function (bid) {
	        ...
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            collection.bids.map(function (bar) {
	              return _react2['default'].createElement(
	                'li',
	                { key: bar.bid + newKey(), onTouchTap: _this.goToBarindex.bind(_this, bar.bid) },
